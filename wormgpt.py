...
CHANNEL_USERNAME = "@aiopistore"
CHANNEL_LINK = "https://t.me/aiopistore"
LOGO_URL = "https://f.top4top.io/p_3614tm0op0.jpeg"
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message and update.message.chat.type == 'private':
        ...
        if not is_member:
            await update.message.reply_text("❌ Silakan join channel dulu! @aiopistore")
            return
